<?php 
    ...
    if($_POST['accion'] == "nueva-escuderia"){
        ...
        try {
            if($categoria == "f1"){
                ...
                $stmt = $con->prepare('UPDATE temporadas SET escuderiasFE = ? WHERE año = ?');
            }
    ...
    if($_POST['accion'] == "nuevo-piloto"){
        ...
        try {
            if($categoria == "f1"){
                ...
                $stmt = $con->prepare('UPDATE temporadas SET pilotosFE = ? WHERE año = ?');
            }
    ...
    if($_POST['accion'] == "nuevos-campeones"){
        ...
        try {
            ...
            else if($categoria == 'fe') $stmt = $con->prepare('UPDATE temporadas SET campeon_pilotos_fe = ?, campeon_escuderias_fe = ? WHERE año = ?');
