<?php
    ...
    function calcularPuntos($temporada, $posicion){
      if($temporada >= 2010){
        ...
        if($posicion == 4) return 5;
        if($posicion == 5) return 4;
        if($posicion == 6) return 3;
        ...
        if($posicion == 3) return 4;
        if($posicion == 4) return 3;
        if($posicion == 5) return 2;
        if($posicion == 6) return 1;
      }
      else if($temporada >= 1961){
    ...
    function calcularPuntosPorVueltaRapida($vueltasRapidas, $temporada){
      ...
      else if($temporada <= 1959) return $vueltasRapidas * 1;
      else return 0;
    }
