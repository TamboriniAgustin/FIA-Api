...
<html lang="en">
  ...
  <body>
    ...
    <div class="seleccionar-tipo text-center" style="margin:20px auto;">
      <a href="historiaf3.php?tipo=pilotos" class="btn p-3 px-xl-4 py-xl-3 <?php if($tipo == "pilotos") echo 'btn-secondary'; else echo 'btn-outline-secondary'; ?>">Pilotos</a>
      <a href="historiaf3.php?tipo=escuderias" class="btn p-3 px-xl-4 py-xl-3 <?php if($tipo == "escuderias") echo 'btn-secondary'; else echo 'btn-outline-secondary'; ?>">Escuderias</a>
      <a href="historiaf3.php?tipo=paises" class="btn p-3 px-xl-4 py-xl-3 <?php if($tipo == "paises") echo 'btn-secondary'; else echo 'btn-outline-secondary'; ?>">Países</a>
      <a href="historiaf3.php?tipo=pistas" class="btn p-3 px-xl-4 py-xl-3 <?php if($tipo == "pistas") echo 'btn-secondary'; else echo 'btn-outline-secondary'; ?>">Pistas</a>
    </div>
    <!-- Tablas de Historia -->
