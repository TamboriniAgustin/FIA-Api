...
<?php
    ...
    else if(strpos($nombrePagina, 'modificar-escuderia') != false) echo '<script src="js/modificaciones.js"></script>';
    else if(strpos($nombrePagina, 'modificar-pista') != false) echo '<script src="js/modificaciones.js"></script>';
    else if(strpos($nombrePagina, 'configuracion') != false) echo '<script src="js/configuracion-temporada.js"></script>';
